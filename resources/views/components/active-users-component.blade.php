@if ($activeUsers ?? '')
    @foreach ($activeUsers as $activeUser)
                ...
                <div class="card-body">
                    <a class="d-block mb-2" href="javascript:void(0)" data-toggle="modal"
                        ...
                        <h5 class="card-title">{{ $activeUser->name ?? '' }} ({{ $activeUser->id }})
                            ...
                            @endif
                            @if ($activeUser->payments->isNotEmpty() && $activeUser->payments->last()->is_paid == 'Active')
                            ...
                            <div class="col">
                                <ul class="list-unstyled d-inline-block mb-5">
                                    <li class="d-flex mb-1">
                                        ...
                                        <span>{{ Str::limit($activeUser->email ?? '', 20) }}</span>
                                    </li>
                                    <li class="d-flex">
        ...
        <div class="modal fade" id="modal-contact-{{ $activeUser->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="card text-center px-0 border-0">
                                        <div class="card-img mx-auto">
                                            <img class="rounded-circle"
                                                src="{{ asset('storage/admin/user-images/' . ($activeUser->image ?? 'male-default.jpg')) }}"
                                                alt="user image">
                                        </div>
                                        <div class="card-body">
                                            <h4 class="py-2">{{ $activeUser->name ?? '' }}</h4>
                                        ...
                                        <div class="col mt-3">
                                            <ul class="list-unstyled d-inline-block mb-5">
                                                ...
                                                <li class="d-flex mb-1">
                                                    ...
                                                    <span>
                                                        <h6>
                                                            {{ isset($activeUser->created_at) ? \Carbon\Carbon::parse($activeUser->created_at)->isoFormat('DD-MMM-YYYY hh:mma') : '' }}
                                                        </h6>
                                                    </span>
                                                </li>
