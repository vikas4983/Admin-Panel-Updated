...
@if ($users ?? '')
    @foreach ($users as $user)
                ...
                <div class="card-body">
                    <a class="d-block mb-2" href="javascript:void(0)" data-toggle="modal"
                        ...
                        <h5 class="card-title">{{ $user->name ?? '' }} ({{ $user->id }}) <i
                            ...
                            @endif
                            @if ($user->payments()->where('is_paid', '1')->exists())
                            ...
                            <div class="col">
                                <ul class="list-unstyled d-inline-block mb-5">
                                    ...
                                    <li class="d-flex">
                                        ...
                                        {{-- <span>{{ $user->birthday ? \Carbon\Carbon::parse($user->birthday)->format('d M Y') : 'N/A' }} ({{ $user->age ?? 'N/A' }} Years)</span> --}}
        ...
        <div class="modal fade" id="modal-contact-{{ $user->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="profile-content-left px-4">
                                    <div class="card text-center px-0 border-0">
                                        <div class="card-img mx-auto">
                                            <img class="rounded-circle"
                                                src="{{ asset('storage/admin/user-images/' . ($user->image ?? 'male-default.jpg')) }}"
                                                alt="user image">
                                        </div>
                                        <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="text-center pb-4">
                                            <h6 class="pb-2">{{ $user->friends_count ?? '120' }}</h6>
                                            <p>Request</p>
                                        </div>
                                        <div class="text-center pb-4">
                                            <h6 class="pb-2">{{ $user->followers_count ?? '20' }}</h6>
                                            <p>Accepted</p>
                                        </div>
                                        <div class="text-center pb-4">
                                            <h6 class="pb-2">{{ $user->following_count ?? '50' }}</h6>
                                            <p>Sent</p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col mt-3">
                                            <ul class="list-unstyled d-inline-block mb-5">
                                                ...
                                                <li class="d-flex mb-1">
                                                    ...
                                                    <span>
                                                        <h6>
                                                            {{ isset($user->created_at) ? \Carbon\Carbon::parse($user->created_at)->isoFormat('DD-MMM-YYYY hh:mma') : '' }}
                                                        </h6>
                                                    </span>
                                                </li>
                                            ...
                                            <ul class="list-unstyled d-inline-block mb-5">
                                                ...
                                                <li class="d-flex mb-1">
                                                    ...
                                                    <li class="d-flex mt-2">
                                                        <span>
                                                            <h6>
                                                                {{ isset($user->payments->last()->expiry_date) ? \Carbon\Carbon::parse($user->payments->first()->expiry_date)->format('d-M-Y') : 'No Expiry Date' }}
                                                            </h6>
                                                        </span>
                                                    </li>
